...
public partial class SholderImplantDatabase
{
    ...
    public string SholderId { get; set; } = null!;
    ...
    public string? HumeralHeads { get; set; }
    ...
    public string? StepsExtractionTechniqueETools { get; set; }

    public string? StepsExtractionTechniqueESteps { get; set; }

    public string? Link { get; set; }

    public string? Notes { get; set; }

    public string? TrinnionNew { get; set; }
